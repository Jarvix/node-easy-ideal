...
function EasyIdeal(config) {
     ...
     */
    this.getPaymentStatus = function (id, status, salt, checksum, transactioncode) {
     ...
     * @param {[type]} transactionId - Transaction ID
     * @param {[type]} transactionCode - Transaction Code
